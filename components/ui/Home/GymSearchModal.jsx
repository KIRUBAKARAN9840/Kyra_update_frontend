...
const GymSearchModal = ({
  ...
  // Stable empty array to prevent FlatList remounts during loading
  ...
  // Memoize header style to prevent re-renders
  ...
  // Memoize ListEmptyComponent to prevent re-renders
  ...
  // Memoize keyExtractor to prevent FlatList remounts
  const keyExtractor = useCallback((item) => item.gym_id || item.id, []);
  ...
  // Handle search text change - pass directly to parent
  // Parent has its own debounce logic (500ms)
    ...
    >
      <View style={styles.container}>
        ...
        <View style={headerStyle}>
          ...
          <Text style={styles.title}>Search Gyms</Text>
...
export default React.memo(GymSearchModal);
