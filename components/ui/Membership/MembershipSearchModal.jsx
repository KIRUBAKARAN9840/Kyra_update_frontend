          ...
          {item.starting_price != null && (
            <View style={styles.priceRow}>
              <Text style={styles.priceText}>
                from ₹{item.starting_price}/month
              </Text>
            </View>
          )}
        </View>
    ...
    >
      <View style={styles.container}>
        ...
        <View style={headerStyle}>
          ...
          <Text style={styles.title}>Search Membership Plans</Text>
...
const styles = StyleSheet.create({
  ...
  listContent: { paddingBottom: 80, paddingTop: 12, flexGrow: 1 },
  ...
  gymName: { fontSize: 16, fontWeight: "600", color: "#333" },
  gymDetailsRow: { flexDirection: "row", alignItems: "center" },
  locationIcon: { marginRight: 4 },
  gymLocation: { flex: 1, fontSize: 13, color: "#666" },
  distanceContainer: {
    flexDirection: "row",
    alignItems: "center",
    marginTop: 2,
  ...
  priceText: { fontSize: 13, fontWeight: "700", color: "#FF5757" },
  emptyContainer: {
    flex: 1,
  ...
  resultsCountText: { fontSize: 14, color: "#666", textAlign: "center" },
});
