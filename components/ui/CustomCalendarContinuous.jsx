...
const CustomCalendarContinuous = ({
  numberOfDays,
  onSelectionChange,
  availableDates = [],
  mode = "continuous", // "continuous" or "custom"
}) => {
  ...
  const isDateAvailable = (date) => {
    // If no available dates provided, all dates are available
  ...
  const handleDatePress = (date) => {
    ...
    if (mode === "continuous") {
      // Continuous date selection (for 5 days)
      ...
      for (let i = 0; i < numberOfDays; i++) {
        ...
        newSelectedDates.push(nextDate);
      }
...
export default CustomCalendarContinuous;
